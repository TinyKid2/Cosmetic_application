...
def play(impath):
  ...
  #데이터 가지고 오기.
  df = pd.read_csv('/Users/stone/programing/vscode/OCR/종합설계_cosmetic/Datas/종합설계_스킨케어 제품 목록_addO.numbers', header=None)
...
print(play("/Users/stone/Downloads/성분_사진확대.pptx"))




# def recommand_byskin():
#   skintype = input('피부타입, dry,normal,oily,sesitive')
#   df = pd.read_excel('/Users/stone/programing/vscode/OCR/종합설계_cosmetic/종합설계_스킨케어 제품 목록_수정.xlsx', header=None)
#   df[3] = df[3].astype(str)
#   df_recommand = df[df[3] == skintype]
#   print(df[df_recommand])
# recommand_byskin()